...
This project is indexed by GitNexus as **dotfiles** (248 symbols, 363 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
> **Note:** `.gitnexus/` is GitNexus internal local state, ignored by git. Project documentation lives in `docs/wiki/`.
